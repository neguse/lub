...
function M.onFrame()
   ...
   local tex = use_texture("readback_rt", 4, 4, RGBA8, nil, 1,
                           { target = true, filter = NEAREST, wrap = CLAMP })
   ...
   local out = os.getenv("LUB_READ_TEXTURE_TEST_OUT") or
               "/tmp/lub_read_texture_test.png"
