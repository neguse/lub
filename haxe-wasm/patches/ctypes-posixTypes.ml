...
(* Arithmetic types *)
let typeof_clock_t () = Ctypes_static.Int64
let typeof_dev_t () = Ctypes_static.Uint64
let typeof_ino_t () = Ctypes_static.Uint64
let typeof_mode_t () = Ctypes_static.Uint32
let typeof_nlink_t () = Ctypes_static.Uint64
let typeof_off_t () = Ctypes_static.Int64
let typeof_pid_t () = Ctypes_static.Int32
let typeof_ssize_t () = Ctypes_static.Int64
let typeof_time_t () = Ctypes_static.Int64
let typeof_useconds_t () = Ctypes_static.Uint32
...
let sizeof_sigset_t () = 128

let alignmentof_sigset_t () = 8
