...
class Compute07 {
  ...
  public static function onFrame() {
    var csR = Io.loadText("samples/data/07_gen_verts.cs.slang");
    var vsR = Io.loadText("samples/data/07_render.vs.slang");
    var fsR = Io.loadText("samples/data/07_render.fs.slang");
    ...
    Gfx.draw(3, { verts: vbuf },
                { shader: shR, depth: false, cull: Gfx.NONE });
    Gfx.endPass();
  }
}
