...
class Postprocess05 {
  ...
  public static function onFrame() {
    var ovsR = Io.loadText("samples/data/05_offscreen.vs.slang");
    var ofsR = Io.loadText("samples/data/05_offscreen.fs.slang");
    var overtsR = Io.loadFloats("samples/data/05_offscreen.verts.lua");
    var pvsR = Io.loadText("samples/data/05_post.vs.slang");
    var pfsR = Io.loadText("samples/data/05_post.fs.slang");
    var pvertsR = Io.loadFloats("samples/data/05_post.verts.lua");
    ...
    var rt = Gfx.useTexture("rt_scene", RT_W, RT_H, Gfx.RGBA8, null, 1,
    ...
    Gfx.draw(3, { verts: bOff },
                { shader: shOff, depth: false, cull: Gfx.NONE });
    Gfx.endPass();
    ...
    Gfx.draw(6, { verts: bPost, scene: rt },
                { shader: shPost, depth: false, cull: Gfx.NONE });
    Gfx.endPass();
  }
}
