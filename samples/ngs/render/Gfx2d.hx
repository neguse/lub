...
class Gfx2d {
	...
	public function ensure():Bool {
		...
		white.texture = Gfx.useTexture("ngs_white", 1, 1, Gfx.RGBA8, lua.Table.fromArray([255, 255, 255, 255]), 1, {filter: Gfx.NEAREST, wrap: Gfx.CLAMP});
		if (drawList == null)
			drawList = new DrawList(shader);
		else
