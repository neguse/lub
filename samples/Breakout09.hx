...
class Breakout09 {
  ...
  static function buildVertices(): Array<Float> {
    ...
    for (b in bricks) {
      if (b.alive) {
        ...
        addRect(out, b.x0 + 0.006, b.y1 - 0.012,
                     b.x1 - 0.006, b.y1 - 0.006,
                     highlight);
      }
    }

    addRect(out, paddleX - PADDLE_W * 0.5, PADDLE_Y - PADDLE_H * 0.5,
                 paddleX + PADDLE_W * 0.5, PADDLE_Y + PADDLE_H * 0.5,
                 paddleColor);
  ...
  public static function onFrame() {
    ...
    var vsR = Io.loadText("samples/data/09_breakout.vs.slang");
    var fsR = Io.loadText("samples/data/09_breakout.fs.slang");
