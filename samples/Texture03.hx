...
class Texture03 {
  ...
  public static function onFrame() {
    var vsResult = Io.loadText("samples/data/03_tex.vs.slang");
    var fsResult = Io.loadText("samples/data/03_tex.fs.slang");
    var vertsResult = Io.loadFloats("samples/data/03_tex.verts.lua");
    var pngResult = Io.loadPng("samples/data/03_tex.png");
