...
class VertexColor02 {
  ...
  public static function onFrame() {
    var vsResult = Io.loadText("samples/data/02_vcol.vs.slang");
    var fsResult = Io.loadText("samples/data/02_vcol.fs.slang");
    var vertsResult = Io.loadFloats("samples/data/02_vcol.verts.lua");
