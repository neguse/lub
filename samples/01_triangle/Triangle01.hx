...
class Triangle01 {
	...
	public static function onFrame() {
		var vsResult = Io.loadText("samples/01_triangle/data/01_triangle.vs.slang");
		var fsResult = Io.loadText("samples/01_triangle/data/01_triangle.fs.slang");
		var vertsResult = Io.loadFloats("samples/01_triangle/data/01_triangle.verts.lua");
		...
		var s = Gfx.useShader("tri_shader", vs, fs, vsv * 31 + fsv);
